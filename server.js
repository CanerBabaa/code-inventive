...
const IDler = {
  botID: "782337028687396894",
  botSecret: "Lw5ngr__H7wjyk_gWR_E49HdYEC_V6L3",
  botCallbackURL: "https://peat-radial-repair.glitch.me/callback",
  sunucuID: "695604119183949874",
  sunucuDavet: "https://discord.gg/7FCPJjhQtx",
  kodLogKanalı: "781829752209670145",
  sahipRolü: "781829644252610590",
  adminRolü: "781829653815361547",
  kodPaylaşımcıRolü: "781829656285544468",
  boosterRolü: "757900467098615819",
  kodPaylaşamayacakRoller: ["781829661340467230", "781829661340467230"],
  hazırAltyapılarRolü: "781829663517179924",
  hazırSistemlerRolü: "781829663517179924",
  sistemlerrolü: "782284764660236338",
  elmasKodlarRolü: "781829664866828308",
  altınKodlarRolü: "781829663948275714",
  normalKodlarRolü: "781829662779244545",
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](https://qenzycode-site.glitch.me/${obj.kod_rank}/${obj.id})`));
...
client.on("ready", () => {
  const listener = app.listen("", function() {
    client.user.setActivity(`Qenzy Code`, { type:"WATCHING" })
